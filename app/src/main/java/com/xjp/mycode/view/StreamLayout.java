...
public class StreamLayout extends ViewGroup {
    ...
    private float mHorizontalSpacing = 6; //每个item横向间距

    public StreamLayout(Context context) {
        this(context, null);
    }

    public StreamLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StreamLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
